...
void DX::DeviceResources::CreateDeviceResources() 
{
    ...
    D3D11_FEATURE_DATA_D3D11_OPTIONS3 d3dFeatureOptions;
    m_d3dDevice->CheckFeatureSupport(D3D11_FEATURE_D3D11_OPTIONS3, &d3dFeatureOptions, sizeof(d3dFeatureOptions));
    if (d3dFeatureOptions.VPAndRTArrayIndexFromAnyShaderFeedingRasterizer)
    {
        m_supportsVprt = true;
    }
}
